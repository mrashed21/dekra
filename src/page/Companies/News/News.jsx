          ...
          <div className="flex items-start gap-4 px-5 lg:px-0">
            <div>
              ...
              <p className="text-secondary mt-2 ml-10">
                Although it sounds similar to the term burnout, the boreout
                still receives much less attention, but it is encountered daily
                by many employees. You may have faced it too, without even
                knowing it.
              </p>
            </div>
          </div>
